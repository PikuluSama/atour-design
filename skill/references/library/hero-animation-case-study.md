...
- 完整技术流程：[references/library/animations.md](animations.md) · [references/library/animation-best-practices.md](animation-best-practices.md)
- 动画导出流水线：[references/library/video-export.md](video-export.md)
- 音频配置（BGM + SFX 双轨）：[references/library/audio-design-rules.md](audio-design-rules.md)
- Apple 画廊风格的横向参考：[references/library/apple-gallery-showcase.md](apple-gallery-showcase.md)
