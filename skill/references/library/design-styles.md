...
>
> **字体同理**：条目里的字体名也是示例锚点。选定风格后，display+body 配对先过 `references/library/typography.md` 的配对逻辑与「已被用烂名单」——**名单与条目冲突时以 typography.md 为准**（如条目写 Fraunces，按名单换 Newsreader 等平替）。
