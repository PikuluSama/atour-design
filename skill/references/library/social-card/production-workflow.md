...
The skill includes a reusable helper at `assets/social-card/magazine-bg-webgl.js`. Copy or inline it into the generated project when a WebGL background is useful.
