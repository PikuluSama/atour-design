...
For the cover title placement and typography on a great photo, see `references/library/social-card/layout-recipes.md` M16 (4 modes: 顶压底沉 / 侧栏立柱 / 角落徽章 / 下沉条带) and `references/library/social-card/image-overlay.md` (subject map + localized tint fallback).
