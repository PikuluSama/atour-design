...
The skill includes `assets/social-card/magazine-bg-webgl.js`, a small helper for a deterministic ink-flow background:

```html
<canvas class="mag-bg" data-seed="workbuddy"></canvas>
<script src="assets/social-card/magazine-bg-webgl.js"></script>
<script>
